    ...
    <footer className="footer" id="contact">
      <div className="footer__inner">
        <div className="footer__cta-wrap">
          <h2 className="footer__title">Ready to Integrate?</h2>
          <p className="footer__subtitle">Talk to us and structure your business for scale.</p>
          <a href="mailto:contact@raynad.com" className="footer__btn">Contact Us</a>
        </div>
